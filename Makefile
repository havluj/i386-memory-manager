...
test1: ccpuimpl.o ccpu.o test_op.o test1.o
	$(LD) $(LDFLAGS) $^ -o $@ $(LIBS)

test2: ccpuimpl.o ccpu.o test_op.o test2.o
	$(LD) $(LDFLAGS) $^ -o $@ $(LIBS)

test3: ccpuimpl.o ccpu.o test_op.o test3.o
	$(LD) $(LDFLAGS) $^ -o $@ $(LIBS)

test4: ccpuimpl.o ccpu.o test_op.o test4.o
	$(LD) $(LDFLAGS) $^ -o $@ $(LIBS)

test5: ccpuimpl.o ccpu.o test_op.o test5.o
	$(LD) $(LDFLAGS) $^ -o $@ $(LIBS)
...
ccpuimpl.o: ccpuimpl.cpp common.h
